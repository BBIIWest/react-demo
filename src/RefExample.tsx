...
const RefForm = () => {
  ...
  return (
    ...
    >
      <div className="mb-3">
        <RenderCounter name="Form" color="purple" />
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            min={1}
            className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent border-gray-300`}
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:outline-none focus:ring-purple-500"
            />
      ...
      <div className="mt-4 p-3 bg-purple-50 rounded-md text-sm text-gray-700">
        <strong>Note:</strong> This form uses{" "}
        <code className="bg-purple-100 px-1 rounded">useRef</code> and{" "}
        <code className="bg-purple-100 px-1 rounded">defaultValue</code>.
...
const RefExample = () => {
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-4">
        <RenderCounter name="RefExample" color="purple" />
      </div>
      <h1 className="text-3xl font-bold mb-6 text-gray-800">
        Ref Example (Uncontrolled)
      </h1>
